...
<template>
  <div class="mobile-scan-root">
    ...
    <!-- ── Header ──────────────────────────────────────────────── -->
  <!-- responsive fix: mobile header stacking and overflow prevention -->
  <header class="mobile-header">
    <div class="header-info-group">
      ...
      <div class="header-text-container">
        ...
        <p class="header-sub">Sess: <code>{{ shortSession }}</code></p>
      </div>
    </div>
...
/* History */
.history-panel { flex:1; padding:16px; overflow-y:auto; }
...
.history-item  { display:flex; justify-content:space-between; align-items:center; padding:10px 12px; background:#1e293b; border:1px solid #334155; border-radius:10px; }
...
/* Controls */
.controls-bar { display:flex; gap:10px; padding:12px 16px; background:#1e293b; border-top:1px solid #334155; }
