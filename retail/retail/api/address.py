...
def get_party_address_info(doctype, party_name, preferred_key='is_primary_address'):
    """
    Get preferred address for a party (Customer / Supplier / etc.)
    """
    ...
    address_name = get_preferred_address(
        doctype,
        party_name,
    ...
    if address_name:
        ...
        address_details = address_doc.as_dict()
...
def create_address(customer, title, line1, city,
    ...
    """أنشئ Address جديد وربطه بـ Customer"""
