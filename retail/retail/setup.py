...
def get_custom_fields():
	return {
        "POS Profile": [
            ...
            {"fieldname": "posa_store_name", "label": "Store Name", "fieldtype": "Data", "insert_after": "posa_store_info"},
            {"fieldname": "posa_store_address", "label": "Store Address", "fieldtype": "Link", "insert_after": "posa_store_name", "options": "Address"},
            {"fieldname": "posa_store_email", "label": "Store Email", "fieldtype": "Data", "insert_after": "posa_store_address"},
            {"fieldname": "posa_column_break_6uxg7", "fieldtype": "Column Break", "insert_after": "posa_store_email"},
            {"fieldname": "posa_tax_id", "label": "Tax Id", "fieldtype": "Int", "insert_after": "posa_column_break_6uxg7"},
            {"fieldname": "posa_store_phone", "label": "Store Phone", "fieldtype": "Phone", "insert_after": "posa_tax_id"},
